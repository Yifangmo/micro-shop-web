module github.com/Yifangmo/micro-shop-web

go 1.18

require (
	github.com/Yifangmo/micro-shop-services v0.0.1
...
replace github.com/Yifangmo/micro-shop-services => /home/yifangmo/go/src/micro-shop/services

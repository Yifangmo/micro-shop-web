...
type GoodsQueryForm struct {
	...
	PageNumber  uint32  `form:"p" binding:"required"`
	PageSize    uint32  `form:"pnum" binding:"required"`
	Keywords    *string `form:"q"`
	BrandID     *int32  `form:"b"`
}
...
type GoodsForm struct {
	...
	MarketPrice float64  `form:"market_price" json:"market_price" binding:"required,min=0"`
	ShopPrice   float64  `form:"shop_price" json:"shop_price" binding:"required,min=0"`
